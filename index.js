...
const birth = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year < 1600));
console.log(birth);
...
const peroplesort = people.sort ((lastperson, nextperson) => {
    const[alast, afirst] = lastperson.split(",");
    const[blast, bfirst] = nextperson.split(",");
    return alast > blast ? 1 : -1;
})
console.log(peroplesort);

//7. Sum up the instances of each of these using reduce
